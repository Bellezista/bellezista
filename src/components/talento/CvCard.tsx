...
export function CvCard({ cv }: { cv: CvResumen }) {
  return (
    <Link
      href={`/talento/${cv.id}`}
      className="group flex flex-col overflow-hidden rounded-xl bg-card p-5 shadow-[var(--shadow-card)] transition-shadow duration-300 hover:shadow-[var(--shadow-card-hover)]"
    >
