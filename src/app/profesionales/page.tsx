    ...
    <div className="flex min-h-screen flex-col bg-white text-foreground">
      ...
      <main className="mx-auto flex max-w-3xl flex-1 flex-col items-center justify-center px-6 py-28 text-center">
        ...
        <h1 className="mt-4 font-serif text-3xl leading-tight md:text-4xl">
          El directorio de profesionales llega muy pronto
        </h1>
        <p className="mt-4 max-w-xl text-muted-foreground">
          Un espacio con las empresas y profesionales que ayudan a tu negocio de
          belleza: gestorías, marketing, licencias, formación, distribuidores y
          más. Estamos preparándolo.
        </p>
      </main>
      <Footer />
    </div>
